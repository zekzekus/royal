/*******************************************************************************
#asset(articlehistory/*)
 ******************************************************************************/
qx.Class.define("articlehistory.Application", {
	...
	members : {
        ...
        getSplitPaneTwoFlexSimple : function() {
            ...
            var lblDate1 = new qx.ui.basic.Label().set({
                content: "<strong>Start Date</strong>", 
                rich: true});
            var lblDot2 = new qx.ui.basic.Label(":");
            var edtDate1 = new qx.ui.form.DateField();
            tabControl1Master.add(lblDate1, {row: 0, column: 3});
            tabControl1Master.add(lblDot2,     {row: 0, column: 4});
            tabControl1Master.add(edtDate1, {row: 0, column: 5});

            var lblDate2 = new qx.ui.basic.Label().set({
                content: "<strong>End Date</strong>", 
                rich: true});
            var lblDot3 = new qx.ui.basic.Label(":");
            var edtDate2 = new qx.ui.form.DateField();
            tabControl1Master.add(lblDate2, {row: 1, column: 3});
            tabControl1Master.add(lblDot3,     {row: 1, column: 4});
            tabControl1Master.add(edtDate2, {row: 1, column: 5});
            ...
            tabControl1Master.add(lblSection, {row: 3, column: 0});
            tabControl1Master.add(lblDot4,     {row: 3, column: 1});
            tabControl1Master.add(edtSection, {row: 3, column: 2});            

            var btnCancel = new qx.ui.form.Button("Cancel", "articlehistory/window-close.png");
            btnCancel.setEnabled(false);
            var lblDot9 = new qx.ui.basic.Label(" ");
            var btnList = new qx.ui.form.Button("Generate List", "articlehistory/go-next.png");
            btnList.setEnabled(false);
            tabControl1Master.add(btnCancel, {row: 8, column: 20});
            tabControl1Master.add(lblDot9,     {row: 8, column: 21});
            tabControl1Master.add(btnList, {row: 8, column: 22});
            
            tabControl1.add(tabControl1Master);            
            tabControl1.setMinHeight(200);
            splitpane.add(tabControl1, 1);
            
            var tabControl2 = new qx.ui.tabview.TabView("top");
            tabControl2.setMinHeight(550);            
        ...
        getDetailData : function() {
            var detailData = [
                [1, "11/24/2008", "City View Residance", 100, 0, 100],
                [2, "11/24/2008", "Hospital", 50, 0, 150],          
                [3, "11/24/2008", "Beach Side Apartment", 50, 0, 200],
                [4, "11/30/2008", "City View Residance", 0, 50, 150],
                [5, "11/30/2008", "Hospital", 0, 10, 140]];
            return detailData;
            
        },
        makeDetailTableModel : function() {
            var detailTableModel = new qx.ui.table.model.Simple();
            detailTableModel.setColumns(["ID", "Date", "Section", "Inbound", "Outbound", "Stock"]);
